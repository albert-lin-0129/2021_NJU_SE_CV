...
if __name__ == "__main__":
    ...
    #     LFWDataset(dir="data/val", pairs_path="tr",image_size=input_shape), batch_size=32, shuffle=False)
    ...
    if True:
        ...
        for epoch in range(Init_Epoch,Interval_Epoch):
            _loss = fit_ont_epoch(model,loss,epoch,epoch_size,gen,val_epoch_size,gen_val,Interval_Epoch,None,Cuda)
    ...
    if True:
        ...
        for epoch in range(Interval_Epoch,Epoch):
            _loss = fit_ont_epoch(model,loss,epoch,epoch_size,gen,val_epoch_size,gen_val,Epoch,None,Cuda)
            lr_scheduler.step(_loss)
