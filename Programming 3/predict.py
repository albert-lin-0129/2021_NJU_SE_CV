...
image_ids = open(r"dataset\data\ImageSets\Segmentation\val.txt",'r').read().splitlines()

if not os.path.exists("./prediction"):
    os.makedirs("./prediction")

for image_id in tqdm(image_ids):
    image_path = "./dataset/data/JPEGImages/"+image_id+".jpg"
    image = Image.open(image_path)
    image = pspnet.detect_image(image)
    image.save("./prediction/" + image_id + ".png")
